...
<thead>
<tr>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[0], $this->lang->line('cmp_id')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[1], $this->lang->line('cmp_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[2], $this->lang->line('lay_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[3], $this->lang->line('cmp_ispage')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[4], $this->lang->line('cmp_iselement')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[5], $this->lang->line('cmp_isrelation')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'components', $columns[6], $this->lang->line('items')); ?>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<tr>
<td><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $result->cmp_id;?>"><?php echo $result->cmp_id;?></a></td>
...
<th>
<a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $result->cmp_id;?>"><?php echo $this->lang->line('update'); ?></a>
<?php if($result->count_items == 0 && $result->cmp_islocked == 0) { ?><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $result->cmp_id;?>"><?php echo $this->lang->line('delete'); ?></a><?php } ?>
</th>
</tr>
<?php } ?>
