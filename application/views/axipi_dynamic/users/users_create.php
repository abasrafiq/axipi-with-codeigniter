...
<p><?php echo form_label($this->lang->line('usr_emailconfirm').' *', 'usr_emailconfirm'); ?><?php echo form_input('usr_emailconfirm', set_value('usr_emailconfirm'), 'id="usr_emailconfirm" class="inputtext"'); ?></p>
</fieldset>
<fieldset>
...
<p><?php echo form_label($this->lang->line('usr_firstname'), 'usr_firstname'); ?><?php echo form_input('usr_firstname', set_value('usr_firstname'), 'id="usr_firstname" class="inputtext"'); ?></p>
<p><?php echo form_label($this->lang->line('usr_lastname'), 'usr_lastname'); ?><?php echo form_input('usr_lastname', set_value('usr_lastname'), 'id="usr_lastname" class="inputtext"'); ?></p>
</div>
