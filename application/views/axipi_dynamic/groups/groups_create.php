...
<?php echo form_open(ci_url().$this->itm->itm_code.'/_create'); ?>
...
<p><?php echo form_label($this->lang->line('grp_isitem'), 'grp_isitem'); ?><?php echo form_checkbox('grp_isitem', 1, set_value('grp_isitem'), 'id="grp_isitem" class="inputcheckbox"'); ?></p>
<p><?php echo form_label($this->lang->line('grp_isuser'), 'grp_isuser'); ?><?php echo form_checkbox('grp_isuser', 1, set_value('grp_isuser'), 'id="grp_isuser" class="inputcheckbox"'); ?></p>
<p><?php echo form_label($this->lang->line('grp_ispermission'), 'grp_ispermission'); ?><?php echo form_checkbox('grp_ispermission', 1, set_value('grp_ispermission'), 'id="grp_ispermission" class="inputcheckbox"'); ?></p>
