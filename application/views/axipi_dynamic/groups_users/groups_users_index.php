...
<thead>
<tr>
<?php display_column(ci_url().$this->itm->itm_code, 'groups_users', $columns[0], $this->lang->line('usr_id')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'groups_users', $columns[1], $this->lang->line('usr_email')); ?>
...
<tr>
<td><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/?usr_id=<?php echo $result->usr_id;?>"><?php echo $result->usr_id;?></a></td>
