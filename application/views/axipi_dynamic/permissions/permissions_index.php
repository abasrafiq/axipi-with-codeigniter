...
<thead>
<tr>
<?php display_column(ci_url().$this->itm->itm_code, 'permissions', $columns[0], $this->lang->line('per_id')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'permissions', $columns[1], $this->lang->line('per_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'permissions', $columns[2], $this->lang->line('groups')); ?>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<tr>
<td><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $result->per_id;?>"><?php echo $result->per_id;?></a></td>
<td><?php echo $result->per_code; ?></td>
<td><?php echo $result->count_groups; ?><?php if($result->count_groups > 0) { ?> (<?php echo $result->groups; ?>)<?php } ?></td>
<th>
<a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $result->per_id;?>"><?php echo $this->lang->line('update'); ?></a>
<?php if($result->count_groups == 0 && $result->per_islocked == 0) { ?><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $result->per_id;?>"><?php echo $this->lang->line('delete'); ?></a><?php } ?>
</th>
</tr>
<?php } ?>
