...
<div class="box1">
<h1><?php echo $this->lang->line('permission'); ?></h1>
<ul>
...
<div class="column1">
<p><?php echo form_label($this->lang->line('per_code').' *', 'per_code'); ?><?php echo form_input('per_code', set_value('per_code'), 'id="per_code" class="inputtext"'); ?></p>
</div>
