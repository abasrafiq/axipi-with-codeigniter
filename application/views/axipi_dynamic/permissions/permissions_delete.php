...
<ul>
<li><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $per->per_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
<li><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $per->per_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(ci_url().$this->itm->itm_code.'/_delete/'.$per->per_id); ?>
