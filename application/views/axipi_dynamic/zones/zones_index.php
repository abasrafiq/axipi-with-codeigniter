...
<thead>
<tr>
<?php display_column(ci_url().$this->itm->itm_code, 'zones', $columns[0], $this->lang->line('zon_id')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'zones', $columns[1], $this->lang->line('zon_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'zones', $columns[2], $this->lang->line('lay_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'zones', $columns[3], $this->lang->line('zon_ordering')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'zones', $columns[4], $this->lang->line('items')); ?>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<tr>
<td><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $result->zon_id;?>"><?php echo $result->zon_id;?></a></td>
...
<th>
<a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $result->zon_id;?>"><?php echo $this->lang->line('update'); ?></a>
<?php if($result->zon_islocked == 0) { ?><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $result->zon_id;?>"><?php echo $this->lang->line('delete'); ?></a><?php } ?>
</th>
</tr>
<?php } ?>
