...
<thead>
<tr>
<?php display_column(ci_url().$this->itm->itm_code, 'sections', $columns[0], $this->lang->line('sct_id')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'sections', $columns[1], $this->lang->line('sct_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'sections', $columns[2], $this->lang->line('lay_code')); ?>
<?php display_column(ci_url().$this->itm->itm_code, 'sections', $columns[3], $this->lang->line('items')); ?>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<tr>
<td><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $result->sct_id;?>"><?php echo $result->sct_id;?></a></td>
<td><?php echo $result->sct_code; ?></td>
<td><?php echo $result->lay_code; ?></td>
<td><?php echo $result->count_items; ?></td>
<th>
<a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $result->sct_id;?>"><?php echo $this->lang->line('update'); ?></a>
<?php if($result->count_items == 0 && $result->sct_islocked == 0) { ?><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $result->sct_id;?>"><?php echo $this->lang->line('delete'); ?></a><?php } ?>
</th>
</tr>
<?php } ?>
