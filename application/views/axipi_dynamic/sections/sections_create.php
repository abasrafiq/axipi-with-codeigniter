...
<div class="box1">
<h1><?php echo $this->lang->line('section'); ?></h1>
<ul>
...
<div class="column1">
<p><?php echo form_label($this->lang->line('sct_code').' *', 'sct_code'); ?><?php echo form_input('sct_code', set_value('sct_code'), 'id="sct_code" class="inputtext"'); ?></p>
