...
<ul>
<?php if($itm->itm_islocked == 0) { ?><li><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('delete'); ?></a></li><?php } ?>
<li><a href="<?php echo ci_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
...
<?php foreach($this->storage_files as $file) { ?>
	<?php if($itm->{$file} && file_exists('storage/'.$this->storage_folder.'/'.$file.'/'.$itm->{$file})) { ?>
		<p><span class="label"><?php echo $this->lang->line($file); ?></span><a href="<?php echo ci_url(); ?>storage/<?php echo $this->storage_folder; ?>/<?php echo $file; ?>/<?php echo $itm->{$file}; ?>"><?php echo $itm->{$file}; ?></a></p>
	<?php } ?>
<?php } ?>
