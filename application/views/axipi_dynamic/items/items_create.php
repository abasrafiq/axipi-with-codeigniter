...
<?php echo form_open_multipart(ci_url().$this->itm->itm_code.'/_create'); ?>
...
<p><?php echo form_label($this->lang->line('itm_ispublished'), 'itm_ispublished'); ?><?php echo form_checkbox('itm_ispublished', 1, set_value('itm_ispublished', 1), 'id="itm_ispublished" class="inputcheckbox"'); ?></p>
